...
export const createRipples = (defaultProps: Partial<RipplesProps> = {}) =>
    class extends React.PureComponent<RipplesProps, State> {
        ...
        render() {
            const { children, during, color, onClick, className, ...props } =
                this.props;
...
const withAttrs =
    <P, Element = HTMLDivElement>(Component: React.ComponentType<P>) =>
    (props: P & Omit<React.HTMLAttributes<Element>, "style">) =>
        <Component {...props} />;

export const Ripples = withAttrs(createRipples());
